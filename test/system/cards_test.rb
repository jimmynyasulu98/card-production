...
class CardsTest < ApplicationSystemTestCase
  ...
  test "should create card" do
    ...
    fill_in "Cover", with: @card.cover_id
    fill_in "Date joined", with: @card.date_joined
    fill_in "Date of expiry", with: @card.date_of_expiry
    fill_in "Location", with: @card.location_id
